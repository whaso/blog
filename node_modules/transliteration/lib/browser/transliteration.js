...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /* global define, window, WorkerGlobalScope, self */
...
_.transliterate.setCharmap(_charmap2["default"]);

var bindGlobals = function bindGlobals(globalObj) {
  var obj = globalObj;
  obj.transl = _.transliterate;
  obj.slugify = _.slugify;
...
},{".":3,"../../data/charmap.json":1}],3:[function(require,module,exports){
'use strict';
...
},{"./slugify":4,"./transliterate":5}],4:[function(require,module,exports){
'use strict';
...
},{"./transliterate":5,"./utils":6}],5:[function(require,module,exports){
'use strict';
...
var transliterate = function transliterate(sourceStr, options) {
  ...
  var i = void 0;var j = void 0;var splitted = void 0;var result = void 0;var ignore = void 0;var ord = void 0;
...
},{"../../data/charmap.json":1,"./utils":6}],6:[function(require,module,exports){
'use strict';
...
var escapeRegExp = exports.escapeRegExp = function escapeRegExp(sourceStr) {
  var str = sourceStr;
...
var parseCmdEqualOption = exports.parseCmdEqualOption = function parseCmdEqualOption(option) {
  ...
  result = opt.split('=').map(function (value) {
